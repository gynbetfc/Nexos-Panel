...
print("\n" + "="*45)
print(f"🚀 RASTREADOR RE-CALIBRADO // SINAL LIMPO")
print(f"🔑 SEU TARGET ID GERADO É: {DEVICE_ID}")
print("="*45 + "\n")
...
while True:
    ...
    # Captura o GPS bruto com o comando limpo de uma execução
    ...
    try:
        ...
        if response.status_code == 200:
            print(f"📡 [ESTÁVEL] GPS enviado: [{lat}, {lon}] | Bat: {battery}%")
